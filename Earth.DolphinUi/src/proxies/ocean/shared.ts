...
// update exported function here as needed for any request preparation common to all Ocean proxies.
export function prepareRequest(request: Request): Request {
    return defaultPrepareRequest(request);
}

// this can be updated as needed for any event handling strategy common to all Ocean proxies.
